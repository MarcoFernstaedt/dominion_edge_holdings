...
router.post('/api/quick-log', validate(z.object({
...
router.post('/api/quick-action/next-action/open', validate(z.object({
...
router.post('/api/quick-action/proof-submit', validate(z.object({
  task_id:      z.string().min(1),
...
router.post('/api/quick-action/approve-and-send', validate(z.object({
...
router.post('/api/exports/:id/cancel', validate(z.object({
  by:     z.string().min(1),
