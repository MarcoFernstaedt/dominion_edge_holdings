...
router.post('/api/timing/summary', (req, res) => {
  try {
...
router.post('/api/timing/alerts', (req, res) => {
  try {
    const entitySets = req.body ?? {};
...
router.get('/api/timing/thresholds', (_req, res) => {
  res.json(ALL_THRESHOLDS);
});

router.post('/api/timing/entity/:entityType/:id', (req, res) => {
...
router.post('/api/recovery/generate', (req, res) => {
  try {
...
router.post('/api/recovery/apply-task-pack', validate(z.object({
