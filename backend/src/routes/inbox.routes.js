...
router.get('/api/inbox/threads', (req, res) => {
  try {
...
router.get('/api/inbox/threads/:id', (req, res) => {
  try {
...
router.post('/api/inbox/compose', validate(ComposeSchema), (req, res) => {
  try {
    const thread = {
      id: uid(),
      createdAt: nowIso(),
...
router.get('/api/outreach/templates', (req, res) => {
  try {
...
router.post('/api/outreach/generate', validate(OutreachGenerateSchema), async (req, res) => {
