...
router.post('/api/underwriting/calculate', validate(UnderwritingCalcSchema), (req, res) => {
  try {
    const {
...
router.get('/api/underwriting/scenarios', (req, res) => {
  try {
...
router.post('/api/underwriting/scenarios', (req, res) => {
  try {
...
router.delete('/api/underwriting/scenarios/:id', (req, res) => {
  try {
